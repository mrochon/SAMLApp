...
namespace SAMLTEST.SAMLObjects
{
    ...
    public class AuthnRequest
    {
        ...
        public AuthnRequest(string Destination, string thisurl, string Issuer)
        {
            ...
            //{
            //   this.AssertionConsumerServiceURL = thisurl + "/AssertionConsumer";
            //}
            //else
            //{
            //    if (thisurl.Contains("samltestapp2"))
            //    {
            //        this.AssertionConsumerServiceURL = "https://samltestapp2.azurewebsites.net/AssertionConsumer";
            //    }
            //    else
            //    {
            //        this.AssertionConsumerServiceURL = "https://samltest20190427104731.azurewebsites.net/AssertionConsumer";
            //    }
            //}
